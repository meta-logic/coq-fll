...
Proof with WFSolver.
  ...
  + (* Conjunction left *)
    ...
    ++ exists ([atom (down' Fo1)] ++ [atom (down' Go1)]).
       ...
       eexists. exists 5...
       left.  exists N...
       decide3' (makeLRuleBin TENSOR Fo1 Go1)...
       tensor' [(atom (down (t_bin TENSOR Fo1 Go1)))] Delta1... 
    ++  exists ([atom (down' Fo1)] ++ [atom (down' Go1)]).
        exists (@nil oo).
        eexists. exists 5...
        rewrite H1.
  ...
  + (* Conjunction right *)
    ...
    ++ exists M0.  exists N0.
       ...
       left...
       tensor' M0 N0...
       decide3' (makeRRuleBin TENSOR Fo1 Go1)...
       tensor' [(atom (up (t_bin TENSOR Fo1 Go1)))] (Delta1 ++ Delta2)...
  ...
  + (* Oplus Left *)
    ...
    ++ exists N.
       ...
       eexists. exists 4...
       left...
       decide3' (makeLRuleBin OPLUS Fo1 Go1)...
       tensor' [ (atom (down (t_bin OPLUS Fo1 Go1)))] Delta12.
    ++ exists N.
       exists [atom (down' Fo1)].
       exists [atom (down' Go1)].
       exists (@nil oo). exists (@nil oo).
  ...
  + (* Oplus Right *)
    ...
    exists N...
    apply tri_plus1'...
    decide3'  (perp (up (t_bin OPLUS Fo1 Go1)) ** (atom (up Fo1) op atom (up Go1))).
    tensor' [ (atom (up (t_bin OPLUS Fo1 Go1)))] Delta1.
