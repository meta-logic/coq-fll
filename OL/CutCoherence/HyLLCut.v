(*  ** HyLL's cut-elimination

This file defines an alternative encoding for HyLL rules. Such
encoding is adequate at the level of proofs and cut-coherent *)

Require Import FLL.SL.CutElimination.
Require Import FLL.OL.CutCoherence.HyLLBase.
...
Section HyLL.
  ...
  (** Here we define a cut-coherent encoding of HyLL's inference rules *)
  ...
  (** Now we prove cut-coherence of the inference rules and then,
  prove cut-elimination for HyLL *)
  
  (** Cut rule at the object level *)
  ...
  (** The main step to prove the cut-elimination theorem *)
  Theorem CutElimStep:
