...
proved and then, using [OLCuti] we prove the cut-elimination
...
Lemma tempLemma : forall L, isOLFormulaL L -> IsPositiveLAtomFormulaL (LEncode L).
 ...
 Lemma tempLemma2 : forall L a x x1,
  ...
  | [ H1: isOLFormulaL ?L, H2: isOLConstant (t_bin _ ?A1 ?A2) |- isOLFormulaL (?A2 :: ?L) ] =>
    ...
    Ltac InForall2 :=
      ...
      | [ H: In ?F (LEncode ?L) |- _ ] => 
        ...
        refine(InPermutation _ _ H); destruct Hp;apply tempLemma3 in H;
...
Qed.
    ...
    Proof with solveF;solveLL.
      ...
      + (* from the theory *)
        inversion H3...
        ++ (* Constant right *)
          apply FocusingRightCte in H6;[|apply (tempLemma H0)].
          CleanContext.
          (* by cases on C *)
          destruct C;simpl in H8...
          inversion H8... (* there is no proof o zero *)
        ++  (* constant left *)
          apply FocusingLeftCte in H6;[|apply (tempLemma H0)].
          CleanContext.
          (* by cases on C *)
          destruct C;simpl in H8...
          inversion H8... (* there is no proof o zero *)
       ...
       ++ (* binary connective right *)
          apply FocusingRightRule in H6;[|apply (tempLemma H0)].
          CleanContext.
          (* by cases on C *)
          destruct C;simpl in H8...
          { (* case AND *)
       ...
       ++  (* binary connective left *)
          apply FocusingLeftRule in H6;[|apply (tempLemma H0)].
          CleanContext.
          (* by cases on C *)
          destruct C;simpl in H8...
          { (* case AND *)
            ...
            *
            ...
            eapply tempLemma2 in H6;[|exact H8].
          ...
          { (*  OR *)
            ...
            *
            ...
            eapply tempLemma2 in H6;[|exact H5].
        ...
        ++ (* Quantifier right *)
          apply FocusingRightQ in H6;[|apply (tempLemma H0)].
          CleanContext.
          (* by cases on C*)
        ...
        ++ (* Quantifier left *)
          apply FocusingLeftQ in H6;[|apply (tempLemma H0)]. 
          CleanContext.
          (* by cases on C*)
          destruct C;simpl in H9...
          { (* case ALL *)
      ...
      + (* init *)
        apply Init_inversion1 in H6;[|apply (tempLemma H0)]...
